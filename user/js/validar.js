...
function validaCadastro(evt){
	...
	var nome_final = document.getElementById('final_name');
	...
	/* Validação do campo Final nome */
	caixa_nome_final = document.querySelector('.msg-final_nome');
	if(nome_final.value == ""){
    caixa_nome_final.style.display = 'block';
		caixa_nome_final.innerHTML = "Favor preencher o Sobrenome";
		contErro += 1;
	}else{
		caixa_nome_final.style.display = 'none';
	}
