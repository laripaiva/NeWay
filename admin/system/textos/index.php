<div class="content cat_list">
    ...
    <div class="neway z-depth-5">
        <p class="title center-align">Gerenciar arquivos no módulo <?php echo $nome['titulo']; ?><a href="painel.php?exe=textos/create&module=<?php echo $moduleId; ?>" class="waves-effect waves-light btn ">Adicionar arquivo</a></p>
    </div>
    ...
    <div class="container">
        <?php
            ...
            if ($empty){
                frontErro("Você tentou editar um arquivo que não existe no sistema.", E_USER_NOTICE);
            }elseif($delete){
                frontErro("O arquivo foi excluído.", ACCEPT);
            }
            $empty = filter_input(INPUT_GET, 'empty', FILTER_VALIDATE_BOOLEAN);
            $update = filter_input(INPUT_GET, 'update', FILTER_VALIDATE_BOOLEAN);
            $delete = filter_input(INPUT_GET, 'delete', FILTER_VALIDATE_BOOLEAN);
        ...
        ?>
            <section>
                ...
                <div class="container">
                    ...
                    <a class="waves-effect  red darken-4 btn" href="painel.php?exe=textos/update&arquivo=<?=$id?>&module=<?=$nome['id'];?>"><i class="material-icons left">edit</i>Editar</a>
                    <a class="waves-effect  red darken-4 btn" href="painel.php?exe=textos/delete&arquivo=<?=$id?>&module=<?=$nome['id'];?>" title="Excluir"><i class="material-icons left">delete_forever</i>Deletar</a>
